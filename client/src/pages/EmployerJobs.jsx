                    ...
                    <div key={index} className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-slate-50/50 transition-colors">
                          ...
                          <div className="flex items-center gap-5 cursor-pointer group flex-1">
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex flex-wrap gap-4 text-sm text-slate-400 font-medium">
                                ...
                                <span className="flex items-center gap-1.5 text-primary"><Badge variant="outline" className="text-[10px] uppercase font-bold py-0">{app.status}</Badge></span>
                              </div>
                            </div>
                          </div>
                        </DialogTrigger>
                        ...
                        <div className="relative shrink-0">
                          ...
                          <div className="absolute -bottom-10 md:-bottom-12 left-6 md:left-10 right-6 md:right-10 flex items-end justify-between">
                            <div className="flex items-end gap-4 md:gap-6">
                              <Avatar className="h-24 w-24 md:h-32 md:h-32 border-[4px] md:border-[6px] border-white shadow-xl shrink-0">
                            ...
                            <div className="lg:col-span-5 xl:col-span-4">
                              <div className="lg:sticky lg:top-6 space-y-6">
                                ...
                                <div className="bg-slate-900 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] text-white space-y-5 md:space-y-6 shadow-2xl">
                                  ...
                                  <div className="space-y-3">
                                    <Button className="w-full bg-primary hover:bg-primary/90 text-white rounded-xl font-bold py-6 md:py-7 text-base md:text-lg shadow-lg shadow-primary/20">
                                      Shortlist Candidate
                                    </Button>
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-1 gap-3">
                                      <Button 
                                        variant="outline" 
                                        className="border-slate-700 bg-transparent text-white hover:bg-slate-800 rounded-xl py-6 md:py-7 gap-2 text-xs md:text-sm"
                                        onClick={() => handleOpenResume(user?.resume)}
                                      >
                                        <Download className="w-4 h-4" /> <span className="hidden sm:inline">Resume</span>
                                      </Button>
                                      <Button variant="ghost" className="text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 py-6 md:py-7 text-xs md:text-sm">
                                        Reject
                                      </Button>
                                    </div>
                                  </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                                  <div className="bg-white p-6 rounded-[1.5rem] border border-slate-100 shadow-sm space-y-3">
                                  ...
                                  <div className="bg-white p-6 rounded-[1.5rem] border border-slate-100 shadow-sm space-y-3">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                      {user?.skills?.map((skill, i) => (
                                        <Badge key={i} className="bg-slate-100 text-slate-600 border-none px-2 py-0 text-[10px]">
                                          {skill}
                                        </Badge>
                                      ))}
                                    </div>
                      ...
                      <div className="flex items-center gap-4">
                        <Button 
                          variant="secondary" 
                          size="sm" 
                          className="rounded-xl h-10 gap-2 font-bold px-4 bg-slate-100 text-slate-700 hover:bg-slate-200"
                          onClick={() => handleOpenResume(user?.resume)}
